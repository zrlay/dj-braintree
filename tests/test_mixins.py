# """
# .. module:: dj-braintree.tests.test_mixins
#    :synopsis: dj-braintree Mixin Tests.
#
...
#
# from djbraintree.mixins import SubscriptionPaymentRequiredMixin, PaymentsContextMixin, SubscriptionMixin
#
#
...
#
#     @patch("djbraintree.mixins.subscriber_has_active_subscription", return_value=False)
...
#         self.assertEqual(response.url, reverse("djbraintree:subscribe"))
#
#         subscriber_has_active_subscription_mock.assert_called_once_with(self.user)
#
#     @patch("djbraintree.mixins.subscriber_has_active_subscription", return_value=True)
...
#         self.assertEqual(context["PLAN_LIST"], djbraintree_settings.PLAN_LIST, "Incorrect PLAN_LIST.")
#
#         self.assertIn("PAYMENT_PLANS", context, "PAYMENT_PLANS missing from context.")
#         self.assertEqual(context["PAYMENT_PLANS"], djbraintree_settings.PAYMENT_PLANS, "Incorrect PAYMENT_PLANS.")
#
#
